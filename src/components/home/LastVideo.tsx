...
async function LastVideo() {
  ...
  const LastVideo = {
    ...
    "snippet": {
      ...
      "description": "Trazando un nuevo rumbo en mi viaje de programación. 💻💡 Si tuviera la oportunidad de empezar de nuevo, estos son los pasos que seguiría para convertirme en un maestro del código. 🚀👨‍💻 \n#programacion ón #DesarrolloDeSoftware #Aprendizaje #ConsejosDeProgramación #Reinicio #CódigoCreativo",
      "thumbnails": {
        "default": {
